...
def train_with_sgd(model, X_train, y_train, learning_rate=0.005, nepoch=1, evaluate_loss_after=5, decay=0.9, 
...
for epoch in range(NEPOCH):
  train_with_sgd(model, x_train, y_train, learning_rate=LEARNING_RATE, nepoch=1, evaluate_loss_after=5, decay=0.9, 
    callback_every=PRINT_EVERY, callback=sgd_callback)
